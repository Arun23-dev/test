...
export default function ExploreResturant({ ExploreResturantData }) {
  const [dataShow, setDataShow] = useState(11);

  const title = ExploreResturantData?.title || "";
  const brands = ExploreResturantData?.brands || [];

  return (
    <div className="flex max-w-[70%] mx-auto container mt-20 mb-10">
      <div>
